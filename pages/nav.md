...
navs:
  常用工具:
    ...
    - name: 'Box Shadows'
      ...
      desc: 'Box Shadows 是一个在线工具，可以帮助你生成 CSS 盒阴影效果'
      icon: 'https://box-shadow.dev/favicon.svg'
    - name: 'Javascript框架语法特性对比'
      link: 'https://component-party.lainbo.com'
      desc: '快速查看Javascript框架语法特性差异'
      icon: 'https://component-party.lainbo.com/favicon.png'
    - name: 'CSS可视化'
      link: 'https://css.bqrdh.com/safety-color'
      desc: 'CSS样式库'
      icon: 'https://css.bqrdh.com/images/logo.png'
    - name: '蜻蜓工具网'
      link: 'https://33tool.com/'
      desc: '各种工具的集合'
      icon: 'https://33tool.com/logo.png'
    - name: 'Nodejs中文网'
  ...
  Vue Ecosystem:
    ...
    - name: 'Vue Hooks Plus'
      ...
      icon: 'https://inhiblabcore.github.io/vue-hooks-plus/logo.svg'
    - name: 'Vue Request'
